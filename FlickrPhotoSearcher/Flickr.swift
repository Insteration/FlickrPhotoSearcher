...
let api = "f843076116700f4726a1512067694366"
...
class Flickr {
    ...
    private func flickrSearchURL(for searchTerm:String) -> URL? {
        ...
        let URLString = "https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=\(api)&text=\(escapedTerm)&per_page=20&format=json&nojsoncallback=1"
